oS.Init({
  PicArr: (function () {
    ...
    return [
      ShadowPNG,
      "images/Sun.gif",
      "images/OptionsMenuback" + a + ".png",
      "images/OptionsBackButton" + a + ".png",
      "images/Surface.png",
      "images/Help.png",
      "images/SelectorScreenStartAdventur.png",
      "images/SelectorScreenSurvival.png",
      "images/Logo.jpg",
  ...
  LevelName: "JSPVZ",
  LoadMusic: function () {
    NewEle("oEmbed", "embed", "width:0;height:0", { src: "music/Faster.swf" }, EDAll);
  },
  LoadAccess: function () {
    EDAll.scrollLeft = 0;
    // 显示游戏界面
    SetBlock($('dSurface'),$('iSurfaceBackground'))
    // EDAll.innerHTML += WordUTF8;  // 游戏准备界面
    // LoadProProcess();  // 加载条
    oSym.Stop();
  },
});
