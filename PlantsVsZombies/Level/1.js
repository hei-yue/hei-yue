oS.Init(
  {
    ...
    InitLawnMower: function () {
      ...
      NewImg(
        ...
        "position:absolute;left:" + oS.LawnMowerX + "px;top:" + (GetY(3) - 60) + "px;z-index:11",
        EDAll
      );
    },
    StartGame: function () {
              ...
              oP.Monitor({
                ...
                f: function (k) {
                  ...
                  switch (k) {
                    ...
                    case 1:
                      i > 0 &&
                        (innerText($("DivTeach"), "点击草地种下豌豆射手，最好种在靠左边！"),
                    ...
                    case 3:
                      oS.SunNum > 99 &&
                        (innerText($("DivTeach"), "你拥有了足够的阳光来种植另一个豌豆射手！"),
  ...
  },
  {
    ...
    FlagToEnd: function () {
      ...
      EditImg($("PointerUD"), 0, "images/interface/PointerDown.gif", { left: "676px", top: "295px", display: "block" });
    },
  }
);
