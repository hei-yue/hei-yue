var CPlants = NewO({
  ...
  oStarfruit = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/StarfruitG.png",
  ...
  oPeashooter = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/PeashooterG.png",
    ...
    Tooltip: "向敌人射出豌豆",
    Produce:
      '豌豆射手，你的第一道防线。它们通过发射豌豆来攻击僵尸。<p>伤害：<font color="#FF0000">中等</font></p>一棵植物，怎么能如此快地生长，并发射如此多的豌豆呢？豌豆射手：“努力工作，风险自己，再加上一份阳光，高纤维和氧化碳均衡搭配，这种健康早餐让一切成为可能。”',
    PrivateBirth: function (c) {
      ...
      c.BulletEle = NewImg(
        0,
        c.PicArr[3],
        "left:" + a + "px;top:" + (c.pixelTop + 3) + "px;display:none;z-index:" + (c.zIndex + 2)
      );
    },
    PrivateDie: function (a) {
      a.BulletEle = null;
  ...
  oSnowPea = InheritO(oPeashooter, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SnowPeaG.png",
  ...
  oRepeater = InheritO(oPeashooter, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/RepeaterG.png",
  ...
  oThreepeater = InheritO(oPeashooter, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/ThreepeaterG.png",
      ...
      for (b in c) {
        ...
        f.BulletEle.push(
          NewImg(
            0,
            "images/Plants/PB00.gif",
            "left:" + d + "px;top:" + (GetY(b) - 50) + "px;display:none;z-index:" + (3 * b + 2)
          )
        );
      }
    },
  ...
  oGatlingPea = InheritO(oPeashooter, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/GatlingPeaG.png",
    ...
    PrivateBirth: function (c) {
      ...
      c.BulletEle = NewImg(
        0,
        c.PicArr[3],
        "left:" + a + "px;top:" + (c.pixelTop + 8) + "px;display:none;z-index:" + (c.zIndex + 2)
      );
    },
  ...
  oSplitPea = InheritO(oPeashooter, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SplitPeaG.png",
  ...
  oSunFlower = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SunFlowerG.png",
      "images/Plants/SunFlower/SunFlower.gif",
    ],
    Tooltip: "提供你额外的阳光",
    Produce:
      '向日葵，为你生产额外阳光的经济作物。尝试尽可能多种植吧！<p>阳光产量：<font color="#FF0000">中等</font></p>向日葵情不自禁地和着节拍起舞。是什么节拍呢？嗨，是大地自己用来提神的爵士节拍，这种频率的节拍，只有向日葵才能听到。',
    PrivateBirth: function (a) {
      oSym.addTask(
        600,
        function (d, c, b) {
          $P[d] &&
            (AppearSun(Math.floor(c + Math.random() * 41), b, 25, 0), oSym.addTask(2400, arguments.callee, [d, c, b]));
        },
  ...
  oTwinSunflower = InheritO(oSunFlower, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/TwinSunflowerG.png",
  ...
  oPumpkinHead = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/PumpkinHeadG.png",
    ...
    getHurt: function (e, c, b) {
      ...
      switch (true) {
        ...
        case d.HP < 1334:
          d.HurtStatus < 2 &&
            ((d.HurtStatus = 2), (a.childNodes[1].src = "images/Plants/PumpkinHead/pumpkin_damage2.gif"));
          break;
        case d.HP < 2667:
          d.HurtStatus < 1 &&
            ((d.HurtStatus = 1),
  ...
  oFlowerPot = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/FlowerPotG.png",
  ...
  oPotatoMine = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/PotatoMineG.png",
    ...
    PrivateBirth: function (a) {
      oSym.addTask(
        ...
        function (c) {
          var b = $P[c];
          b &&
            (($(c).childNodes[1].src = "images/Plants/PotatoMine/PotatoMine.gif"),
            (b.Status = 1),
            (b.canTrigger = 1),
            (b.getHurt = function (g, e, d) {
              var f = this;
    ...
    TriggerCheck: function (e, c) {
      ...
      e.beAttacked &&
        e.Altitude < 2 &&
        !oGd.$[a + "_" + b + "_2"] &&
        this.NormalAttack(this.pixelLeft, this.pixelLeft + this.width, this.R);
    },
    NormalAttack: function (k, j, f) {
      ...
      EditEle(
        ...
        { width: "132px", height: "93px", left: "-40px", top: "-20px" }
      );
  ...
  oTorchwood = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/TorchwoodG.png",
  ...
  oWallNut = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/WallNutG.png",
    ...
    CanGrow: function (c, b, e) {
      var a = b + "_" + e,
        d = c[1];
      return d && d.EName == "oWallNut"
        ? 1
        : oGd.$LF[b] == 1
        ? !(e < 1 || e > 9 || oGd.$Crater[a] || oGd.$Tombstones[a] || d)
        : c[0] && !d;
    },
    InitTrigger: function () {},
    HurtStatus: 0,
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 2667 &&
            c.HurtStatus < 1 &&
            ((c.HurtStatus = 1), (d.src = "images/Plants/WallNut/Wallnut_cracked1.gif"))
        : c.Die(1);
    },
  }),
  oTallNut = InheritO(oWallNut, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/TallNutG.png",
    ...
    getHurt: function (e, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1
          ...
          : c.HP < 5333 &&
            c.HurtStatus < 1 &&
            ((c.HurtStatus = 1), (d.src = "images/Plants/TallNut/TallnutCracked1.gif"))
        : c.Die(1);
    },
  }),
  oCherryBomb = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/CherryBombG.png",
        ...
        function (b) {
          ...
          if (c) {
            ...
            EditEle(
              ...
              { width: "213px", height: "160px", left: "-50px", top: "-30px" }
            );
  ...
  oJalapeno = InheritO(oCherryBomb, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/JalapenoG.png",
        ...
        function (g) {
          ...
          if (f) {
            ...
            EditEle(
              ...
              { left: 120 - f.pixelLeft + "px", top: "-42px" }
            );
  ...
  oSpikeweed = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SpikeweedG.png",
    ...
    getHurt: function (d, b, a) {
      ...
      !(b % 3)
        ? (c.HP -= a) < 1 && c.Die()
        : b < 2
        ? (d.getHurt(1, 0, 20, 0, 0, 0, 0), c.Die(1))
        : ((d.HP = d.BreakPoint), d.GoingDie(), c.Die());
    },
  ...
  oSpikerock = InheritO(oSpikeweed, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SpikerockG.png",
  ...
  oGarlic = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/GarlicG.png",
        ...
        ? (c.HP -= 20) < 1
          ...
          : (c.ChangeR(c, e),
            c.HP < 134
              ...
              : c.HP < 267 &&
                c.HurtStatus < 1 &&
                ((c.HurtStatus = 1), (d.src = "images/Plants/Garlic/Garlic_body2.gif")))
        : c.Die(1);
    },
  ...
  oSquash = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SquashG.png",
  ...
  oChomper = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/ChomperG.png",
            ...
            ((e = $Z[d]) && e.beAttacked
              ? oSym.addTask(
                  ...
                  function (f) {
                    var g = $P[f];
                    g &&
                      ($(f).childNodes[1].src = e.getRaven(f)
                        ? (oSym.addTask(
                            4200,
                            function (h) {
                              var i = $P[h];
  ...
  oFumeShroom = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/FumeShroomG.png",
    ...
    PrivateBirth: function (b) {
      ...
      NewEle(
        a + "_Bullet",
        "div",
        "position:absolute;display:none;width:343px;height:62px;left:" +
          b.AttackedRX +
          "px;top:" +
          (b.pixelTop + 5) +
  ...
  oCoffeeBean = InheritO(CPlants, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/CoffeeBeanG.png",
      "images/Plants/CoffeeBean/CoffeeBean.gif",
      "images/Plants/CoffeeBean/CoffeeBeanEat.gif",
    ],
    ...
    PrivateBirth: function (a) {
      oSym.addTask(
        ...
        function (c) {
          ...
          d &&
            ((b = d.WakeUP),
            !b ? (($(d.id).childNodes[1].src = d.PicArr[d.NormalGif]), (d.canTrigger = 1), (d.Sleep = 0)) : b(d));
          a.Die();
        },
        [a.R + "_" + a.C + "_1"]
      );
  ...
  oGloomShroom = InheritO(oFumeShroom, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/GloomShroomG.png",
    ...
    PrivateBirth: function (b) {
      ...
      NewEle(
        a + "_Bullet",
        "div",
        "position:absolute;display:none;width:210px;height:200px;left:" +
          (b.pixelLeft - 60) +
          "px;top:" +
          (b.pixelTop - 65) +
  ...
  oPuffShroom = InheritO(oFumeShroom, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/PuffShroomG.png",
    ...
    PrivateBirth: function (c) {
      ...
      c.BulletEle = NewImg(
        0,
        "images/Plants/ShroomBullet.gif",
        "left:" + a + "px;top:" + (c.pixelTop + 40) + "px;display:none;z-index:" + (c.zIndex + 2)
      );
    },
    PrivateDie: function (a) {
      a.BulletEle = null;
  ...
  oScaredyShroom = InheritO(oFumeShroom, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/ScaredyShroomG.png",
    ...
    TriggerCheck: function (e, c) {
      var b = this,
        a = b.id;
      Math.abs(e.ZX - b.MX) < 121 && e.beAttacked
        ? (b.ArZ.push(e.id),
          !b.Cry &&
            ((b.Cry = 1), ($(a).childNodes[1].src = "images/Plants/ScaredyShroom/ScaredyShroomCry.gif"), b.CryCheck(a)))
        : !b.Cry && !b.Attacking && e.Altitude > 0 && e.Altitude < 3 && b.NormalAttack();
    },
    PrivateBirth: function (c) {
      var b = c.AttackedLX,
        a = b - 46;
      ...
      c.BulletEle = NewImg(
        0,
        "images/Plants/ShroomBullet.gif",
        "left:" + a + "px;top:" + (c.pixelTop + 35) + "px;display:none;z-index:" + (c.zIndex + 2)
      );
      c.MX = b + 9;
    },
    PrivateDie: function (a) {
      ...
      oSym.addTask(
        ...
        function (b) {
          ...
          if (d) {
            ...
            f.length
              ? d.CryCheck(b)
              : ((d.Cry = 0), ($(b).childNodes[1].src = "images/Plants/ScaredyShroom/ScaredyShroom.gif"));
          }
        },
        [a]
      );
  ...
  oSunShroom = InheritO(oFumeShroom, {
    ...
    PicArr: [
      ...
      "images/Card/Plants/SunShroomG.png",
