var CZombies = (function (b, a) {
      ...
      ((a = function () {}).prototype = {
        ...
        Init: function (g, j, e, d) {
          ...
          j.ArHTML = [
            ...
            ",0);top:",
            'px" src="' + j.PicArr[j.NormalGif] + '"></div>',
          ];
        },
        ...
        Die: function (d) {
          var e = this,
            ...
            c = $(f);
          !d
            ? ((c.childNodes[1].src = e.PicArr[e.DieGif] + Math.random()), oSym.addTask(250, ClearChild, [c]))
            : d < 2
            ? ((c.childNodes[1].src = e.PicArr[e.BoomDieGif] + Math.random()), oSym.addTask(300, ClearChild, [c]))
            : ClearChild(c);
          e.HP = 0;
          delete $Z[f];
          oP.MonPrgs();
        ...
        GoingDieHead: function (e, c, d) {
          oSym.addTask(200, ClearChild, [
            NewImg(
              ...
              "left:" + d.AttackedLX + "px;top:" + (d.pixelTop - 20) + "px;z-index:" + d.zIndex,
              EDAll
            ),
          ]);
        },
        ...
        JudgeAttack: function () {
          ...
          (c = g.JudgeLR(g, e, f, d, h) || g.JudgeSR(g, e, f, d, h))
            ? c[0](c[1], c[2])
            : g.isAttacking && ((g.isAttacking = 0), ($(g.id).childNodes[1].src = g.PicArr[g.NormalGif]));
        },
          ...
          oSym.addTask(
            ...
            function (g, f) {
              ...
              j &&
                ...
                !j.FreeFreezeTime &&
                !j.FreeSetbodyTime &&
                ((h = $P[f]) && h.getHurt(j, j.AKind, !j.FreeSlowTime ? j.Attack : Math.round(j.Attack * 0.5)),
                j.JudgeAttack());
            },
            [d, c]
          );
        ...
        default:
          ...
          switch (q) {
            ...
            default:
              ...
              if (e.canSputtering) {
                f = !a
                  ? oZ.getArZ(e.AttackedLX, e.AttackedLX + 40, e.R)
                  : oZ.getArZ(e.AttackedRX - 40, e.AttackedRX, e.R);
  ...
  oZombie = InheritO(OrnNoneZombies, {
    ...
    Produce:
      '普通僵尸<p>韧性：<font color="#FF0000">低</font></p>这种僵尸喜爱脑髓，贪婪而不知足。脑髓，脑髓，脑髓，夜以继日地追求着。老而臭的脑髓？腐烂的脑髓？都没关系。僵尸需要它们。',
  }),
  oFlagZombie = InheritO(
    oZombie,
    {
      EName: "oFlagZombie",
      CName: "旗帜僵尸",
    ...
    getHurt: function (j, a, g, n, c, l, k) {
      ...
      switch (true) {
        ...
        default:
          e.OrnHP = 0;
          $(b).childNodes[1].src =
            e.PicArr[[(e.NormalGif = e.OrnLostNormalGif), (e.AttackGif = e.OrnLostAttackGif)][f]];
      }
      switch (n) {
        case 0:
          break;
        case -1:
          e.canSlow &&
            (!e.FreeSlowTime && (e.Speed = e.OSpeed * 0.5),
            oSym.addTask(
              1000,
              function (o, r, q) {
    ...
    JudgeAttack: function () {
      ...
      for (f = c - 2; f <= c; f++) {
        ...
        for (
          ...
          p.AttackedRX >= e &&
          p.AttackedLX < b &&
          ((a = -1), (g.JudgeAttack = CZombies.prototype.JudgeAttack), g.NormalAttack(g.id, p.id))
        ) {}
      }
    },
    getRaven: function (a) {
      ...
      oSym.addTask(
        ...
        function (l, j, h, k, r) {
          ...
          q &&
            ((m = $P[j]) && m.Stature > 0
              ? ((q.AttackedRX =
                  (q.X = (q.AttackedLX = q.ZX = n = m.AttackedRX) - q.beAttackedPointL) + q.beAttackedPointR),
                SetStyle(h, { left: q.X + "px" }),
                (r.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif"),
                SetBlock(k),
                (q.isAttacking = 0),
                (q.Altitude = 1),
                (q.OSpeed = q.Speed = 1.6),
                (q.NormalGif = 7),
                (q.LostHeadGif = 8),
                (q.NormalAttack = CZombies.prototype.NormalAttack),
                (q.getRaven = CZombies.prototype.getRaven))
              : ((q.ZX = q.AttackedLX = (q.X = (q.AttackedRX = f) - q.beAttackedPointR) + q.beAttackedPointL),
                SetStyle(h, { left: q.X + "px" }),
                (r.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieJump2.gif" + $Random + Math.random()),
                SetBlock(k),
                oSym.addTask(
                  80,
                  function (s, u) {
                    var t = $Z[s];
                    t &&
                      ((u.src = "images/Zombies/PoleVaultingZombie/PoleVaultingZombieWalk.gif"),
                      (t.isAttacking = 0),
                      (t.Altitude = 1),
                      (t.OSpeed = t.Speed = 1.6),
                      (t.NormalGif = 7),
                      (t.LostHeadGif = 8),
                      (t.NormalAttack = CZombies.prototype.NormalAttack),
                      (t.getRaven = CZombies.prototype.getRaven));
                  },
                  [l, r]
                )));
        },
  ...
  OrnIIZombies = InheritO(CZombies, {
    ...
    getHurt: function (h, a, e, l, c, k, j) {
      ...
      d.OrnHP
        ? !h
          ? ((d.OrnHP = Math.max(d.OrnHP - e, 0)), (d.HP -= e))
          : h == -1 && !a
          ? (d.OrnHP = Math.max(d.OrnHP - e, 0))
          : (d.HP -= e)
        : (d.HP -= e);
      switch (true) {
        case !d.OrnHP:
        ...
        case d.HP > d.BreakPoint:
          switch (l) {
            ...
            default:
              ...
              if (d.canSputtering) {
                ar = !a
                  ? oZ.getArZ(d.AttackedLX, d.AttackedLX + 40, d.R)
                  : oZ.getArZ(d.AttackedRX - 40, d.AttackedRX, d.R);
                for (i = ar.length; i--; ar[i].canSputtering && ar[i].getHurt(1, 0, 13, 0, 0, 0, 0)) {}
              }
          }
          SetAlpha($(b).childNodes[1], 50, 0.5);
  ...
  oNewspaperZombie = InheritO(OrnIIZombies, {
    ...
    Produce:
      '他的报纸只能提供有限的防御。<p>韧性：<font color="#FF0000">低</font><p>报纸韧性：<font color="#FF0000">低</font></p><p>速度：正常，而后快(失去报纸后)</p>读报僵尸，他正痴迷于完成他的数独难题。难怪他这么反常。',
    getShadow: function (a) {
    ...
    GoingDie: function (b) {
      ...
      oSym.addTask(200, ClearChild, [
        NewImg(
          ...
          "left:" + a.AttackedLX + "px;top:" + (a.pixelTop - 20) + "px;z-index:" + a.zIndex,
          EDAll
        ),
      ]);
      a.beAttacked = 0;
          ...
          switch (true) {
            ...
            default:
              !(e.OrnHP = Math.max(m - g, 0)) &&
                ((e.isAttacking = 1),
                (e.FreeSlowTime = ""),
                ($(b).childNodes[1].src = d[e.LostPaperGif]),
                oSym.addTask(
                  150,
                  function (s, t, r, q) {
