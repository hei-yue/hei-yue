var $User = (function () {
  ...
  ShadowPNG =
    "images/plantshadow" +
    ($User.Browser.IE6 ? (document.execCommand("BackgroundImageCache", false, true), "8.gif") : "32.png"),
  innerText = (function () {
  ...
  oS = {
      ...
      (
        ...
        function () {
          ...
          GetC = function (f) {
            return $SSml(
              f,
              [100, 140, 220, 295, 379, 460, 540, 625, 695, 775, 855, 935],
          ...
          GetY1Y2 = function (f) {
            return $SEql(f, { 0: [0, 85], 1: [86, 180], 2: [181, 280], 3: [281, 385], 4: [386, 475], 5: [476, 600] });
          };
          !oS.InitLawnMower &&
            (oS.InitLawnMower = function () {
              ...
              while (--f) {
                ...
                NewImg(
                  ...
                  "left:" + oS.LawnMowerX + "px;top:" + (GetY(f) - 60) + "px;z-index:" + (3 * f + 2),
                  EDAll
                );
              }
            });
    ...
    CheckImg: function (b, a) {
      ...
      if (c.AccessNum == c.PicNum) {
        ...
        (oS.AutoSun = $User.Client.PC && $User.HTTP ? Math.floor(getCookie("JSPVZAutoSun")) : 1) &&
          ($("cAutoSun").checked = true);
        delete c.PicArr;
        delete c.Coord;
        delete c.LF;
        delete c.ZF;
              ...
              function () {
                ...
                d < 500
                  ...
                  : (DisplayZombie(),
                    SetBlock($("dMenu")),
                    oS.CanSelectCard
                      ? (SetBlock($("dTop"), $("dSelectCard")), SetVisible($("dCardList")))
  ...
  oP = {
    ...
    AddZombiesFlag: function (d) {
      ...
      for (e in c) {
        Math.floor(e) < a ? SetStyle(c[e], { display: "block", left: 150 - (e - 1) * b + "px" }) : SetBlock(c[e]);
      }
      oGd.MoveBullet();
      g.ReadyFlag = 1;
      g.FlagPrgs(d);
    ...
    FlagPrgs: function () {
      ...
      f.FlagNum > (c = ++f.FlagZombies)
        ? (($("imgFlagHead").style.left = a + "px"),
          ($("imgFlagMeterFull").style.clip = "rect(0,157px,21px," + (a + 11) + "px)"),
        ...
        : (($("imgFlagHead").style.left = "-1px"), ($("imgFlagMeterFull").style.clip = "rect(0,157px,21px,0)"));
    ...
    MonPrgs: function () {
      ...
      !--c.NumZombies &&
        (a < c.FlagNum
          ? ((b = $SEql(a, c.FlagToMonitor)) && (b[0](), (b[1] = 1)),
            (c.ReadyFlag = ++a),
            oSym.addTask(500, c.FlagPrgs, []))
          : (c.FlagToEnd(), oSym.Stop()));
    },
  ...
  oGd = {
    ...
    MB1: function (e, j, m, f) {
      ...
      n < 1 &&
        f[g + "_" + c] &&
        l != c &&
        ((e.Kind = ++n) && (h = e.Attack = 40), (e.ChangeC = c), (k.src = "images/Plants/PB" + n + a + ".gif"));
      b && b.Altitude == 1
        ? (b.getHurt(-1, a, h, n, 0, 0, 0),
          m.splice(j, 1),
          (SetStyle(k, { left: e.pixelLeft + 28 + "px" }).src = "images/Plants/PeaBulletHit.gif"),
    ...
    MB2: function (d, g, h) {
      ...
      b && b.Altitude == 1
        ? (b.getHurt(-1, 0, 20, 0, 0, 0, 0),
          h.splice(g, 1),
          (SetStyle(e, { left: d.pixelLeft + 38 + "px" }).src = "images/Plants/ShroomBulletHit.gif"),
        ...
        switch (g.D) {
          ...
          case 7:
            (g.X += 4.3) > 900 || (c = g.pixelTop -= 5) < -15
              ? (a.splice(d, 1), ClearChild(b))
              : ((g.R = GetR(c + 15)), (b.style.left = (g.pixelLeft += 9.6) + "px"), (b.style.top = c + "px"));
            break;
          case 1:
  ...
  oZ = {
    ...
    getZ: function (k, b, g) {
      ...
      if (!g) {
        ...
        (l = m.RefreshTime) == h.RefreshTime
          ? (j = h)
          : ((j = (this.$R[b] = m.slice(0)).sort(function (i, d) {
    ...
    traversalOf: function () {
      ...
      (function (n) {
        ...
        while (m--) {
          ...
          !c.HP
            ? (i.splice(m, 1), d(c))
            : !(c.FreeFreezeTime || c.FreeSetbodyTime)
            ? (c.beAttacked && !c.isAttacking && c.JudgeAttack(),
              (g = c.id),
              !c.isAttacking
                ? ((a = c.Speed),
                  !c.WalkDirection
                    ? (c.AttackedRX -= a) < 100
                      ? (GameOver(), oSym.Stop(), (m = 0), (n = 1))
                      : (c.ZX = c.AttackedLX -= a) < 150 && oGd.$LM[n]
                      ? (i.splice(m, 1), c.Die(2), LawnMowerKill(n), d(c))
                      : (($(g).style.left = Math.floor((c.X -= a)) + "px"), b(c))
                    : (c.AttackedLX += a) > oS.W
                    ? (i.splice(m, 1), c.Die(2), d(c))
                    : ((c.ZX = c.AttackedRX += a), ($(g).style.left = Math.ceil((c.X += a)) + "px"), b(c)))
                : b(c))
            : b(c);
        }
        k
          ? ((k = 0),
            ...
            (i.RefreshTime = oSym.Now))
          : Refresh && (i.RefreshTime = oSym.Now);
  ...
  oT = {
    ...
    check: function (b, l, k, e, a, j, c) {
      ...
      if (!b.WalkDirection) {
        ...
        (k = g.RefreshTime) == (j = this.$L[c]).RefreshTime
          ? (l = j)
          : ((l = (this.$L[c] = g.slice(0)).sort(function (m, i) {
              return m[0] - i[0];
            })).RefreshTime = k);
  ...
  GetAP = function (a, h, d, c) {
    ...
    for (
      ...
      g.push((e = i[d + "_" + c + "_" + f++])),
        e && !(a < e.pixelLeft || a > e.pixelRight || h < e.pixelTop || h > e.pixelBottom) && (b = e)
    ) {}
    return [g, b];
  },
  ...
  InitPCard = function () {
    ...
    while (b < a) {
      ...
      d +=
        '<span class="span1" id="Card' +
        EName +
        '" onmouseout="SetNone($(\'dTitle\'))" onmousemove="ViewCardTitle(\'' +
        EName +
  ...
  SelectCard = function (f) {
    ...
    if (!i.Select) {
      ...
      oS.StaticCard &&
        ...
        NewImg(0, a.src, 0, h),
        innerText(NewEle("sSunNum" + f, "span", 0, 0, h), c.SunNum),
        (a.src = c.PicArr[c.CardGif + 1]));
    } else {
      i.Select = 0;
    ...
    if (oS.Chose < 1) {
      while (a--) {
        (b = (c = ArCard[a]).PName.prototype).SunNum > oS.SunNum
          ? (c.SunReady && (c.SunReady = 0), ($(c.DID).firstChild.src = b.PicArr[b.CardGif + 1]))
          : (!c.SunReady && (c.SunReady = 1), c.CDReady && ($(c.DID).firstChild.src = b.PicArr[b.CardGif]));
      }
    } else {
      while (a--) {
        (b = (c = ArCard[a]).PName.prototype).SunNum > oS.SunNum
  ...
  DoCoolTimer = function (c, b) {
    ...
    (function (d, g, f, e) {
      d > 0
        ? (innerText(f, d), innerText(e, d), oSym.addTask(50, arguments.callee, [(d - 0.5).toFixed(1), g, f, e]))
  ...
  ChosePlant = function (a, f) {
    ...
    EditImg(
      EditImg(
        ...
        "MovePlant",
        "",
        { left: g - d.width * 0.5 + "px", top: e + 20 - d.height + "px", zIndex: 254 },
        EDAll
      ).cloneNode(false),
      "MovePlantAlpha",
      "",
  ...
  ChoseShovel = function (a) {
    WhichMouseButton(a) < 2 &&
      ...
      NewImg(
        ...
        "left:" + (a.clientX - 10) + "px;top:" + (a.clientY + document.body.scrollTop - 17) + "px;z-index:1",
        EDAll
      ),
      (oS.Chose = -1),
      StopBubble(a));
  ...
  GrowPlant = function (i, c, b, d, a) {
    var g = oS.ChoseCard,
      ...
      h = f.prototype;
    h.CanGrow(i, d, a) &&
      (new f().Birth(c, b, d, a, i),
      innerText(ESSunNum, (oS.SunNum -= h.SunNum)),
      ($(e.DID).firstChild.src = h.PicArr[h.CardGif + 1]),
      (e.CDReady = 0),
      DoCoolTimer(g, h.coolTime),
      SetStyle($("imgGrowSoil"), { left: c - 30 + "px", top: b - 40 + "px", zIndex: 3 * d, display: "block" }),
  ...
  AppearSun = function (h, f, e, a) {
    ...
    a
      ...
      : ((d = f - b - 20), (c += ";top:" + d + "px"), oSym.addTask(800, DisappearSun, [g]));
  ...
  MoveDropSun = function (c, b) {
    ...
    a &&
      a.C &&
      (a.top < b - 53
        ? (($(c).style.top = (a.top += 3) + "px"), oSym.addTask(5, MoveDropSun, [c, b]))
    ...
    (function (k, l, n, s, m, r, j, q, p) {
      (m -= q) > n
        ? (SetStyle($(k), { left: m + "px", top: (r -= p) + "px" }),
          oSym.addTask(j, arguments.callee, [k, l, n, s, m, r, (j += 0.3), q, p]))
        : (SetStyle($(k), { left: n + "px", top: s + "px" }), delete ArSun[k], oSym.addTask(20, ClearChild, [$(k)]));
    })(b, c, e, i, d, h, 1, g, f);
  },
  ...
  PrepareGrowPlants = function (a) {
    NewImg(
      "PrepareGrow",
      "images/PrepareGrowPlants.gif" + $Random + Math.random(),
      "z-index:50;left:" + (oS.W * 0.5 - 77) + "px;top:" + (oS.H * 0.5 - 54) + "px",
      EDAll
    );
    oSym.addTask(
      250,
...
(CheckAutoSun = function (a) {
  ...
  (GetNewCard = function (a, b, c) {
    ...
    oSym.Init(
      function (d, e) {
        ++d < 100
          ? (SetAlpha(e, d, d * 0.01), oSym.addTask(1, arguments.callee, [d, e]))
          : (function () {
    ...
    oSym.Init(
      function (d) {
        ...
        NewEle(
          ...
          "script",
          "",
          { src: "level/" + (oS.Lvl = d) + ".js", type: "text/javascript" },
  ...
  (AppearTombstones = function (j, d, h) {
    ...
    while (h--) {
      ...
      g.splice(e, 1);
      a = NewEle(
        "Tombstones_" + Math.random(),
        "div",
        "position:absolute;width:86px;height:91px;left:" + (GetX(b) - 43) + "px;top:" + (GetY(f) - 91) + "px",
        0,
        EDAll
      );
  ...
  (PauseGame = function (b) {
    var a = oSym;
    a.Timer
      ? (a.Stop(), innerText(b, "回到游戏"), ($("dMenu1").onclick = null))
      : (a.Start(), innerText(b, "暂停游戏"), ($("dMenu1").onclick = ClickMenu));
  }),
  (ClickMenu = function () {
